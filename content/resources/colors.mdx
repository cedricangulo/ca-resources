...
<Cards>
  ...
  <CustomCard
    title="Colormind"
    icon="/resources/colors/colormind.gif"
...
<Cards>
  ...
  <CustomCard
    title="ColorFlow"
    description="Create stunning mesh gradients with ColorFlow. Professional gradient editor with real-time preview, customizable control points, and export options. Perfect for designers and developers."
  ...
  />
  <CustomCard
    title="OKLCH Gradient Generator"
    description="Generate beautiful OKLCH gradients"
    href="https://oklch-gradient.vercel.app/"
  />
  <CustomCard
    title="Paletton"
